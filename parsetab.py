...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','main.py',23),
  ('statement -> expression','statement',1,'p_statement_expression','main.py',29),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','main.py',35),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','main.py',36),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','main.py',37),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','main.py',38),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','main.py',51),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','main.py',57),
  ('expressions -> expressions COLON expression','expressions',3,'p_expressions','main.py',63),
  ('expressions -> expression','expressions',1,'p_expressions','main.py',64),
  ('expressions -> <empty>','expressions',0,'p_expressions','main.py',65),
  ('expression -> NAME LPAREN expressions RPAREN','expression',4,'p_expression_function','main.py',74),
  ('expression -> NUMBER_INT','expression',1,'p_expression_number','main.py',208),
  ('expression -> NUMBER_DOUBLE','expression',1,'p_expression_number','main.py',209),
  ('expression -> NAME','expression',1,'p_expression_name','main.py',215),
]
